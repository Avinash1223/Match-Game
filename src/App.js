...
class App extends Component {
  ...
  render() {
    const {isTrue, category, score, timer, imgUrl} = this.state
    const thumbnailList = imagesList.filter(
      eachListItem => eachListItem.category === category,
    )
    return (
        ...
        <nav className="nav-bar">
          ...
          <ul className="score-timer-container">
            ...
            <li className="score-timer-container">
              ...
              />
              <p className="count-down">{timer} sec</p>
            </li>
          </ul>
        </nav>
        <div className="thumbnail-img-container">
          {!isTrue && (
            <div className="thumbnail-list-container">
              <img src={imgUrl} alt="match" className="image" />
              <div>
                <ul className="tab-items">
                  {tabsList.map(eachTabItem => (
                    <li key={eachTabItem.tabId}>
                      <button
                        type="button"
                        className="tab-Button"
                        onClick={() => this.clickTab(eachTabItem.tabId)}
                      >
                ...
                <ul className="thumbnail-list-items">
                  {thumbnailList.map(eachObj => (
                    <li key={eachObj.id}>
                      <button
                        type="button"
                        className="thumbnail-btn"
                        onClick={() => this.imageClick(eachObj.thumbnailUrl)}
                      >
                        <img
